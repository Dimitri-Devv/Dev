...
export const HookUseEffect = () => {
    ...
    useEffect(() => {
        ...
        //return() => console.log("Retour du useEffect 'count");
    ...
    useEffect(() => {
        ...
        return () => 
            console.log("la fonction qui se déclenchera lors de la destruction du composant");
  ...
  return (
    <>
      ...
      <ul>
        ...
        <li>pour effectuer des opérations après le rendu du composant
            (<strong> comme des appels à des API</strong>, la manipulation du DOM, la gestion d'abonnements...)
        </li>

        <p><strong>useEffect() est très souvent utilisé en conjonction avec un useState</strong></p>
